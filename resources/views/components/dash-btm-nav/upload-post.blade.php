    <x-page-component.bottom-navigation>
        <a href="{{url('post/englishpost/create')}}" data-tooltip-target="tooltip-english" class="inline-flex flex-col items-center justify-center w-full px-5 rounded-s-full hover:bg-gray-50 dark:hover:bg-gray-800 group {{ request()->is('post/englishpost/create') ? 'bg-gray-50 text-blue-500' : '' }}">
        ...
        <a href="{{url('post/nepalipost/create')}}" data-tooltip-target="tooltip-nepali" class="inline-flex flex-col items-center justify-center px-5 w-full hover:bg-gray-50 dark:hover:bg-gray-800 group rounded-e-full {{ request()->is('post/nepalipost/create') ? 'bg-gray-50 text-blue-500' : '' }}">
            <span class="w-5 h-5 mb-1 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"> 
                <i class='fas fa-file-lines'></i>
            </span>
