    ...
    <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700"> 
        ...
        <form class="space-y-6" action="{{url('roles/'.$role->id)}}" method="POST">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{$role->name}}" class="bg-gray-50 border ]text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white @error('name') border-red-300 @enderror" placeholder="" required />
                @error('name')
            ...
            <div>
                ...
                <input type="text" value="{{$role->description}}" name="description" id="description" class="bg-gray-50 border ]text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white @error('description') border-red-300 @enderror" placeholder="" required />
                @error('description')
                <span class="text-red-500">{{$message}}</span>
                @enderror
            </div>
