                ...
                @foreach ($posts as $post)
                    <tr
                        ...
                        <td class="px-3 py-4 grid gap-3 border-l">
                            ...
                            <a href="{{ url('post/nepalipost/'.$post->id.'/restore') }}"
                                ...
                                @endcanany
                                @can('delete post')
                                <form action="{{ url('post/nepalipost/'.$post->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure delete this post ?')">
                                    @csrf
                                    @method('DELETE')
