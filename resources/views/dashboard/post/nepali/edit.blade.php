    ...
    <div class="container mx-auto px-4 py-8 w-full flex items-center justify-center">
        <div class="w-[90%]">
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mb-8 h-fit">
                ...
                <form action="{{ url('post/nepalipost/'.$post->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-4 hidden" id="attached">
                        <label for="" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2"><i
                            ...
                            (English)</label>
                        <input type="text" name="post_id" value="{{$link}}"
                            class="border  dark:border-gray-600 rounded-md px-3 py-2 w-full slug-field  focus-visible:border-none dark:bg-gray-700 dark:placeholder-gray-400 @error('post_id') focus:outline-red-500 border-red-500 @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="keywords" value="{{$post->keywords}}"
                            class="border  dark:border-gray-600 rounded-md px-3 py-2 w-full  focus-visible:border-none @error('keywords') focus:outline-red-500 border-red-500 @enderror dark:bg-gray-700 dark:placeholder-gray-400"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="page-description-nepali" name="content" rows="3"
                            ...
                            placeholder="लेख्नुहोस्..">{{$post->content}}</textarea>
                    </div>
                    @error('status')
