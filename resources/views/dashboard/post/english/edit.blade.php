    ...
    <div class="container mx-auto px-4 py-8 w-full flex items-center justify-center">
        <div class="w-[90%]">
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mb-8">
                ...
                <form action="{{ url('post/englishpost/'.$post->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        <label for="" class="block text-sm font-bold text-gray-700 dark:text-gray-300"><i
                            ...
                            class="border  dark:border-gray-600 rounded-md px-3 py-2 w-full focus-visible:border-none dark:bg-gray-700 dark:placeholder-gray-400 @error('title') focus:outline-red-500 border-red-500 @enderror"
                    ...
                    <label class="inline-flex items-center mb-5 cursor-pointer">
                        ...
                        <input type="checkbox" value="" class="sr-only peer" id="switchSlug" @if (!$errors->any(['slug','feature_img']) && !$slug) checked @endif >
                        <div
                    ...
                    <div class="mb-4 hidden" id="attached">
                        <label for="" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2"><i
                            ...
                            (Nepali)</label>
                            <input type="text" name="post_id" value="{{$link}}"                 class="border  dark:border-gray-600 rounded-md px-3 py-2 w-full slug-field  focus-visible:border-none dark:bg-gray-700 dark:placeholder-gray-400 @error('post_id') focus:outline-red-500 border-red-500 @enderror"
                    ...
                    <div class="mb-4" id="not-attached">
                        <label for="" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2"><i
                            ...
                            class="border  dark:border-gray-600 rounded-md px-3 py-2 w-full slug-field  focus-visible:border-none dark:bg-gray-700 dark:placeholder-gray-400 @error('slug') focus:outline-red-500 border-red-500 @enderror"
                    ...
                    <div class="mb-4" id="nepali-featureImg">
                        ...
                        <img class="image-preview max-h-44 shadow-md mb-3 rounded-lg" src="@if ($post->feature_img) {{asset($post->feature_img)}} @endif">
                        <input
                    ...
                    <div class="mb-4">
                        <label for="" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2"><i
                            ...
                            class="border  dark:border-gray-600 rounded-md px-3 py-2 w-full  focus-visible:border-none dark:bg-gray-700 dark:placeholder-gray-400 @error('keywords') focus:outline-red-500 border-red-500 @enderror"
                    ...
                    <div class="mb-4">
                        <label for="" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Tags
                            ...
                            class="border  dark:border-gray-600 rounded-md px-3 py-2 w-full dark:bg-gray-700 dark:placeholder-gray-400"
                            placeholder="tags">
                            @error('tags')
                            <span class="text-red-500 mt-1">{{$message}}</span>
                            @enderror
                    ...
                    <div class="mb-4">
                        <label for="" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2"><i
                            ...
                            class="border  dark:border-gray-600 rounded-md px-3 py-2 w-full  focus-visible:border-none @error('meta_description') focus:outline-red-500 border-red-500 @enderror dark:bg-gray-700 dark:placeholder-gray-400"
                        ...
                        <div class="select w-full">
                            ...
                            <select
                                ...
                                @for ($i = 1; $i < count($jsonData['navigation']['name']); $i++)
                                    <option value="{{ $i }}" {{ $post->category == $i ? 'selected' : '' }}>{{ $jsonData['navigation']['name'][$i] }}
                                    </option>
                                @endfor
                            </select>
                            @error('category')
                        ...
                        <div class="select w-full">
                            ...
                            <select
                                ...
                                @foreach ($uniqueItems as $index => $item)
                                    <option value="{{ $item }}"{{ $post->sub_category == $item ? 'selected' : '' }}>{{ $item }}</option>
                                @endforeach
                            </select>
                            @error('sub_category')
                            <span class="text-red-500 mt-1">{{$message}}</span>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="content" id="page-description-english" rows="3"
                            class="border border-gray-300 dark:border-gray-600  rounded-md px-3 py-2 w-full" placeholder="Content..">{{$post->content}}</textarea>
                    </div>
