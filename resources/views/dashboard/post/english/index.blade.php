                ...
                <div data-popper-arrow></div>
                    ...
                    <tr data-popover-target="popover-post-info-{{$count}}"
                        ...
                        <td class="px-3 py-4 text-black relative">
                           ...
                           <a href="{{ url($post->slug ? $post->slug : $post->post->slug) }}" class="hover:underline">{{ $post->title }}</a>
                        </td>
